                        ...
                        <ul>
                            ...
                            <li>
                                <a class="btn btn-primary .get-started-btn" style="max-width: 200px"
                                    href="https://api.whatsapp.com/send/?phone=6287889900384&text&type=phone_number&app_absent=0"
                                    target="_blank">
        ...
        <div class="container-fluid">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-9 d-flex align-items-center justify-content-lg-between">
                    <a href="{{ url('/') }}" class="logo me-auto me-lg-0"></a>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-8">
                    ...
                    <h2>aplikasi keuangan pribadi yang membantu Anda mengelola keuangan dengan
